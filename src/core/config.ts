...
export function resolveConfig(overrides: Partial<ClawConfig> = {}): ClawConfig {
  ...
  return {
    ...
    paths,
    idleBeforeStart: projectCfg.idleBeforeStart ?? 0,
    ...
    promptBudgets: {
      ...
      identity: projectCfg.promptBudgets?.identity ?? 200,
      tools: projectCfg.promptBudgets?.tools ?? 300,
      boot: projectCfg.promptBudgets?.boot ?? 300,
    },
